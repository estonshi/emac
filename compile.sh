...
cp ./new_project.sh ./bin/emac.new_project
chmod u+x ./bin/emac.new_project
...
nvcc -c ./src/base_cuda.cu -o ./src/base_cuda.o --use_fast_math -lcufft -lcufftw -O3 -Wno-deprecated-gpu-targets
...
gcc ./src/base_cuda.o ./src/tst_merge.o ./src/emac_data.o -o ./bin/emac.tst.slice_merge -L $cuda_lib -lcudart -lcufft -lcufftw -lm

gcc ./src/base_cuda.o ./src/tst_ang_corr.o ./src/emac_data.o -o ./bin/emac.tst.ang_corr -L $cuda_lib -lcudart -lcufft -lcufftw -lm
