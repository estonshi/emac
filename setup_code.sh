...
gcc ./src/gen_quat.c ./src/tst_gen_quat.c -o ./bin/gen_quat
gcc ./src/emac_data.c ./src/tst_emac_data.c -o ./bin/emac_data
gcc ./src/params.c ./src/gen_quat.c ./src/emac_data.c -o ./bin/params